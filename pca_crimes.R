...
#scaling of data
y=matrix(c(a,b,c1,d,e,f,g,h,i,j,k,l,m,n1,o,p1,q,r,s,t,u), nrow = 9, ncol = 21, byrow = FALSE)
#print(y)
y2=abs(scale(y))
...
cpc=matrix(nrow=21,ncol=9,byrow=TRUE,dimnames=list(c("x1","x2","x3","x4","x5","x6","x7","x8","x9","x10","x11","x12","x13","x14","x15","y16","y17","y18","y19","y20","y21"),c("PC11","PC2","PC3","PC4","PC5","PC6","PC7","PC8","PC9")))
for(i in 1:21)
{
for(j in 1:9)
{
